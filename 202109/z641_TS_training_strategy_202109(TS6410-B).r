...
PARAM  <- list()
PARAM$experimento <- "TS6410-B"

PARAM$exp_input  <- "FE6310"

# me salteo los meses duros de pandemia (202006, 202005, 202004), llego hasta 201903 en training
# entreno en 24 meses

PARAM$future       <- c( 202109 )
PARAM$final_train  <- c( 202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202003, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905 )

PARAM$train$training     <- c( 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202003, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903 )
...
PARAM$train$semilla  <- 111111  # cambiar por su propia semilla  !!! 
