...
PARAM  <- list()
PARAM$experimento  <- "ZZ6920-B"
PARAM$exp_input  <- "HT6510-B"
...
PARAM$semillas  <- c( 111111, 222222, 333333, 444444, 555555, 666666, 777777 ) #reemplazar por las propias semillas

PARAM$kaggle$envios_desde  <-  7000
PARAM$kaggle$envios_hasta  <- 14000
